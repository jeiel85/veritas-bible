package com.veritasbible.app.repository
...
class BibleRepository(
    ...
    suspend fun ensurePrepopulated(onProgress: suspend (Float, String) -> Unit = { _, _ -> }) =
        withContext(Dispatchers.IO) {
            BibleDataPrepopulator.prepopulateIfEmpty(appContext, bibleDao, onProgress)
        }
    ...
    suspend fun prepopulateBible(onProgress: suspend (Float, String) -> Unit = { _, _ -> }) =
        withContext(Dispatchers.IO) {
            BibleDataPrepopulator.prepopulateIfEmpty(appContext, bibleDao, onProgress)
        }
